...
function whereabouts_load_menu_page() {
	...
	<div class="wrap">
		...
		?>
			...
			<hr />
			<p><?php _e( 'In order to use this feature, you must enable the <strong>Google Maps JavaScript</strong>, <strong>Google Maps Geocoding</strong> and <strong>Google Maps Time Zone </strong> APIs in your <a href="https://developers.google.com/console/">Google Developer Console</a>. The plugin will send a test request to the api to validate your key.', 'whereabouts' ); ?></p>
			<p><label for="google-maps-api-key"><strong><?php _e ('Google API Key', 'whereabouts' ); ?></strong></label> <input type="text" name="whab_settings[google-maps-api-key]" id="google-maps-api-key" value="<?php if ( isset( $options['google-maps-api-key'] ) && $options['google-maps-api-key'] != '' ) { echo $options['google-maps-api-key']; } ?>" /> <span class="whab-loading"><span>loading</span></span> <input type="submit" class="button secondary" id="whab-validate-key" name="" value="<?php _e( 'Validate API Key', 'whereabouts' ); ?>"></p>
